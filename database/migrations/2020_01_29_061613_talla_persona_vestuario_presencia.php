...
class TallaPersonaVestuarioPresencia extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('caphum_tallas_persona_vestuario_presencia', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('caphum_tallas_persona_vestuario_prensencia');
    }
}
