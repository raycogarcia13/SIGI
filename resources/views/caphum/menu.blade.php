<a href="{!! route('caphum') !!}" class="default-link-sidebar"><div class="mark-alt"></div>Inicio</a>
<a href="{!! route('caphum.areas.index') !!}" class="default-link-sidebar"><div class="mark-alt"></div>Organigrama</a>
